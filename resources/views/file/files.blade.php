...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8 animate-fade-in">
        <div class="glass-dark rounded-xl p-6 card-hover">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-400">Total File</p>
    ...
    <!-- Main Content -->
    <div class="glass-dark rounded-2xl shadow-xl p-8 animate-slide-in">
        <!-- Table Header -->
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
            <div>
                <h3 class="text-xl font-bold text-white">Daftar File Verifikasi</h3>
                <p class="text-gray-300 mt-1">Semua file verifikasi TUK yang tersimpan</p>
            </div>
            <div class="mt-4 sm:mt-0">
                <button onclick="window.location.reload()" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-gray-700 text-gray-300 rounded-lg hover:bg-gray-700 transition-colors">
                        ...
                        @forelse ($all_files_view as $file)
                            <tr class="hover:bg-gray-700/30 transition-colors">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-8 w-8 bg-blue-900/50 rounded-full flex items-center justify-center border border-blue-700/50">
                                            <span class="text-xs font-semibold text-blue-300">{{ substr($file['no_surat'], 0, 2) }}</span>
                                        </div>
                                        <div class="ml-3">
                                            <p class="text-sm font-medium text-gray-100">{{ $file['no_surat'] }}</p>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <p class="text-sm text-gray-400">{{ \Carbon\Carbon::parse($file['created_at'])->format('d M Y') }}</p>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td colspan="4" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-gray-400 text-sm">Belum ada file verifikasi</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse

...
@section('roleBadge')
    <div class="inline-flex items-center px-6 py-3 bg-white/10 backdrop-blur rounded-full border border-white/20">
        <svg class="w-6 h-6 text-red-400 mr-3" fill="currentColor" viewBox="0 0 24 24">
            <path d="M5 16L3 5l5.5 5L12 4l3.5 6L21 5l-2 11H5zm2.86-2h8.28l.96-5.85-4.21 1.31L12 8l-1.89 1.46-4.21-1.31L7.86 14z"/>
            <path d="M7.86 14l.96-5.85L12 8l3.18 1.46L16.14 14H7.86z"/>

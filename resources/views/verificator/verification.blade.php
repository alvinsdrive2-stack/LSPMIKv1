...
@section('content')
    ...
    <!-- Main Form Section -->
    <div class="rounded-2xl shadow-xl p-8 animate-fade-in">
        <!-- Form Header -->
        <div class="mb-8 text-center">
            <div class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-gray-600 to-gray-950 rounded-2xl mb-4">
                <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/>
                </svg>
            </div>
            <h2 class="text-3xl font-bold text-gray-950 mb-2">Form Verifikasi TUK</h2>
            <p class="text-gray-800">STANDAR PERSYARATAN JABATAN KERJA</p>
        </div>
        ...
        <form action="{{ route('verify') }}" method="POST" class="space-y-8">
            ...
            <div class="card rounded-xl p-6 border border-gray-400">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <!-- Lokasi Gedung -->
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        <input name="gedung" id="gedung" type="checkbox" value="Yes" class="h-4 w-4 text-[#1F3A73] focus:ring-[#1F3A73] border-gray-300 rounded">
                        <label for="gedung" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="bangunan" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="ruangan" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="internet" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="proyektor" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">
                            Monitor / Proyektor
                        </label>
                    </div>
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="pc" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="mejaasesor" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="mejaasesi" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="komunikasi" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="dokumentasi" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">
                    ...
                    <div class="lg:col-span-3">
                        <label for="pendingin" class="block text-sm font-medium text-gray-800 mb-2">
                            Spesifikasi Pendingin Ruangan
                        </label>
                        <select id="pendingin" name="pendingin" class="w-full px-4 py-3 border border-gray-400 rounded-lg focus:ring-2 focus:ring-[#1F3A73] focus:border-transparent transition-all duration-200 text-gray-900">
            ...
            <div class="card rounded-xl p-6 border border-gray-400">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="pulpen" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Pulpen</label>
                    </div>

                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        <input name="pensil" id="pensil" type="checkbox" value="Yes" class="h-4 w-4 text-[#1F3A73] focus:ring-[#1F3A73] border-gray-300 rounded">
                        <label for="pensil" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Pensil</label>
                    </div>

                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        <input name="tipex" id="tipex" type="checkbox" value="Yes" class="h-4 w-4 text-[#1F3A73] focus:ring-[#1F3A73] border-gray-300 rounded">
                        <label for="tipex" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Correction Tape</label>
                    </div>
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="penghapus" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Penghapus Pensil</label>
                    </div>

                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        <input name="spidol" id="spidol" type="checkbox" value="Yes" class="h-4 w-4 text-[#1F3A73] focus:ring-[#1F3A73] border-gray-300 rounded">
                        <label for="spidol" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Spidol</label>
                    </div>
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="penggaris" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Penggaris Min. 30cm</label>
                    </div>

                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        <input name="hvs" id="hvs" type="checkbox" value="Yes" class="h-4 w-4 text-[#1F3A73] focus:ring-[#1F3A73] border-gray-300 rounded">
                        <label for="hvs" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">HVS A4</label>
                    </div>
                </div>
            </div>
            ...
            <div class="card rounded-xl p-6 border border-gray-400">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="apd" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">APD</label>
                    </div>

                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        <input name="apk" id="apk" type="checkbox" value="Yes" class="h-4 w-4 text-[#1F3A73] focus:ring-[#1F3A73] border-gray-300 rounded">
                        <label for="apk" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">APK</label>
                    </div>

                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        <input name="p3k" id="p3k" type="checkbox" value="Yes" class="h-4 w-4 text-[#1F3A73] focus:ring-[#1F3A73] border-gray-300 rounded">
                        <label for="p3k" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">P3K</label>
                    </div>

                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        <input name="rambu" id="rambu" type="checkbox" value="Yes" class="h-4 w-4 text-[#1F3A73] focus:ring-[#1F3A73] border-gray-300 rounded">
                        <label for="rambu" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Rambu Keselamatan Kerja</label>
                    </div>
                </div>
            </div>
            ...
            <div class="card rounded-xl p-6 border border-gray-400">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="theodolite" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Theodolite</label>
                    </div>
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="meteran" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Meteran</label>
                    </div>
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="waterpass" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Waterpass</label>
                    </div>
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="autocad" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Autocad</label>
                    </div>
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="perancah" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Perancah</label>
                    </div>
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="bouwplank" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Bouwplank</label>
                    </div>

                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        <input name="patok" id="patok" type="checkbox" value="Yes" class="h-4 w-4 text-[#1F3A73] focus:ring-[#1F3A73] border-gray-300 rounded">
                        <label for="patok" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Patok / Bench Mark</label>
                    </div>

                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        <input name="jidar" id="jidar" type="checkbox" value="Yes" class="h-4 w-4 text-[#1F3A73] focus:ring-[#1F3A73] border-gray-300 rounded">
                        <label for="jidar" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Jidar</label>
                    </div>

                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        <input name="bandul" id="bandul" type="checkbox" value="Yes" class="h-4 w-4 text-[#1F3A73] focus:ring-[#1F3A73] border-gray-300 rounded">
                        <label for="bandul" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Lot / Bandul</label>
                    </div>
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="palu_karet" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Palu Karet</label>
                    </div>
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="palu_besi" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Palu Besi</label>
                    </div>
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="tang_jepit" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Tang Jepit</label>
                    </div>
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="tang_potong" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Tang Potong</label>
                    </div>
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="gergaji_kayu" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Gergaji Kayu</label>
                    </div>
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="gergaji_besi" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Gergaji Besi</label>
                    </div>
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="gerinda" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Mesin Gerinda</label>
                    </div>
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="pembengkok" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Pembengkok Besi</label>
                    </div>
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="mesin_bor" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Mesin Bor</label>
                    </div>
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="mesin_serut" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Mesin Serut</label>
                    </div>
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="mesin_gergaji" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Mesin Gergaji</label>
                    </div>

                    <!-- Peralatan Kayu -->
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        <input name="pahat" id="pahat" type="checkbox" value="Yes" class="h-4 w-4 text-[#1F3A73] focus:ring-[#1F3A73] border-gray-300 rounded">
                        <label for="pahat" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Pahat Kayu</label>
                    </div>

                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        <input name="obeng" id="obeng" type="checkbox" value="Yes" class="h-4 w-4 text-[#1F3A73] focus:ring-[#1F3A73] border-gray-300 rounded">
                        <label for="obeng" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Obeng</label>
                    </div>
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="cangkul" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Cangkul / Sekop</label>
                    </div>
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="sendok_semen" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Sendok Semen</label>
                    </div>

                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        <input name="ember" id="ember" type="checkbox" value="Yes" class="h-4 w-4 text-[#1F3A73] focus:ring-[#1F3A73] border-gray-300 rounded">
                        <label for="ember" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Ember</label>
                    </div>
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="pengerik" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Alat Pengerik / Kape</label>
                    </div>
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="roll_cat" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Kuas Roll Cat</label>
                    </div>

                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        <input name="cat" id="cat" type="checkbox" value="Yes" class="h-4 w-4 text-[#1F3A73] focus:ring-[#1F3A73] border-gray-300 rounded">
                        <label for="cat" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Cat</label>
                    </div>
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="kuas_cat" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Kuas Cat</label>
                    </div>

                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        <input name="nampan" id="nampan" type="checkbox" value="Yes" class="h-4 w-4 text-[#1F3A73] focus:ring-[#1F3A73] border-gray-300 rounded">
                        <label for="nampan" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Nampan Cat</label>
                    </div>

                    <!-- Lain-lain -->
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        <input name="benang" id="benang" type="checkbox" value="Yes" class="h-4 w-4 text-[#1F3A73] focus:ring-[#1F3A73] border-gray-300 rounded">
                        <label for="benang" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Benang</label>
                    </div>

                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        <input name="paku" id="paku" type="checkbox" value="Yes" class="h-4 w-4 text-[#1F3A73] focus:ring-[#1F3A73] border-gray-300 rounded">
                        <label for="paku" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Paku</label>
                    </div>
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="ampelas" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Ampelas</label>
                    </div>
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="triplek" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Triplek</label>
                    </div>

                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        <input name="lakban" id="lakban" type="checkbox" value="Yes" class="h-4 w-4 text-[#1F3A73] focus:ring-[#1F3A73] border-gray-300 rounded">
                        <label for="lakban" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Masking Tape / Lakban</label>
                    </div>

                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        <input name="dempul" id="dempul" type="checkbox" value="Yes" class="h-4 w-4 text-[#1F3A73] focus:ring-[#1F3A73] border-gray-300 rounded">
                        <label for="dempul" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Dempul</label>
                    </div>
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="papan_applicator" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Papan Applicator</label>
                    </div>
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-400 hover:bg-gray-400/50 transition-colors">
                        ...
                        <label for="penggaris_siku" class="ml-3 block text-sm font-medium text-gray-800 cursor-pointer">Penggaris Siku</label>
                    </div>
                </div>
            </div>
            @endif
    ...
    <button type="submit"
            class="bg-gray-800 hover:bg-gray-900 text-white flex items-center space-x-3 px-8 py-3 font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
        ...
        <div class="flex items-center justify-center min-h-screen p-4">
            <div class="glass-dark rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
                <div class="flex items-center justify-between p-4 border-b border-gray-400">
                    ...
                    <button onclick="closeModal()" class="p-2 hover:bg-gray-700 rounded-lg transition-colors text-gray-800">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
